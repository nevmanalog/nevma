...
export const DICT = {
  ...
  // physical tool help text — one entry per exposed control, grouped by tool
  hSandSize: { en: 'Size of the sanding pad — bigger covers more area per pass.', ru: 'Размер шлифовальной подушки — больше подушка, шире область за проход.' },
  hSandPressure: { en: 'How hard the pad is pressed. Higher wears through colour and paper faster, and can eventually rub a hole.', ru: 'Насколько сильно прижата подушка. Выше — быстрее стирается краска и бумага, может протереться дыра.' },
  hSandAngle: { en: 'Pad angle for a single tap. While dragging, the pad follows the direction of your stroke instead.', ru: 'Угол подушки для одиночного касания. При протягивании подушка сама разворачивается по направлению движения.' },
  hSandRandom: { en: 'How uneven the wear looks — higher gives a patchier, less uniform pass instead of a smooth gradient.', ru: 'Насколько неровным выглядит истирание — выше даёт пятнистый след вместо ровного градиента.' },
  hWaterSize: { en: 'Radius of the wet patch.', ru: 'Радиус мокрого пятна.' },
  hWaterPressure: { en: 'How much water soaks into the paper — higher wets it more and cockles the sheet more visibly.', ru: 'Сколько воды впитывается в бумагу — выше сильнее намокание и заметнее коробление листа.' },
  hWaterAngle: { en: 'Patch angle for a single tap. While dragging, the wash follows the direction of your stroke instead.', ru: 'Угол пятна для одиночного касания. При протягивании пятно само следует за направлением движения.' },
  hKnifeSize: { en: 'Length of the cut laid down per pass.', ru: 'Длина реза, наносимого за один проход.' },
  hKnifePressure: { en: 'How hard the blade bites. Higher opens the cut wider and darkens the shadow along it.', ru: 'Насколько сильно врезается лезвие. Выше — шире раскрывается разрез и темнее тень вдоль него.' },
  hKnifeKerf: { en: 'Width of the slice relative to its length — narrow thin cut vs a wider slice.', ru: 'Ширина прорези относительно длины — от тонкого надреза до широкого среза.' },
  hKnifeFiber: { en: 'How much torn, fuzzy fibre is lifted along the cut edges.', ru: 'Насколько сильно вздёргивается рваное волокно вдоль краёв разреза.' },
  hScratchSize: { en: 'Length and width of the scratched area.', ru: 'Длина и ширина области царапины.' },
  hScratchPressure: { en: 'Overall intensity — how much colour is stripped and how deep the groove is scored.', ru: 'Общая интенсивность — сколько краски стирается и насколько глубоко продавливается бороздка.' },
  hScratchRandom: { en: 'How much the scratch path wanders instead of running dead straight.', ru: 'Насколько сильно виляет траектория царапины вместо идеально прямой линии.' },
  hMarkerSize: { en: 'Width of the marker tip.', ru: 'Ширина кончика маркера.' },
  hMarkerPressure: { en: 'How much ink is laid down per pass — controls how dense the fill looks.', ru: 'Сколько чернил кладётся за проход — влияет на плотность заливки.' },
  hMarkerInk: { en: 'How saturated the ink is, and how visible the wet sheen is before it soaks in.', ru: 'Насколько насыщены чернила и насколько заметен блеск, пока они не впитались.' },
  hMarkerBleed: { en: 'How far the ink wicks out past the tip into the paper fibres.', ru: 'Насколько далеко чернила растекаются за пределы кончика по волокнам бумаги.' },
  hMarkerColor: { en: 'Ink colour.', ru: 'Цвет чернил.' },
  hPencilSize: { en: 'Thickness of the pencil line.', ru: 'Толщина линии карандаша.' },
  hPencilPressure: { en: 'How hard you press — more of the paper grain picks up graphite and the line goes darker.', ru: 'Насколько сильно нажим — больше зерна бумаги цепляет графит, линия темнее.' },
  hPencilGrit: { en: 'How readily graphite catches on the paper texture at a given pressure.', ru: 'Насколько охотно графит цепляется за фактуру бумаги при заданном давлении.' },
  hPencilHardness: { en: 'Harder lead gives a lighter, more metallic line that resists going fully black; softer lead is darker and digs a deeper groove.', ru: 'Твёрдый грифель — светлее и с металлическим блеском, хуже доходит до черноты; мягкий — темнее и глубже продавливает бумагу.' },
  hPencilColor: { en: 'Lead colour (also lets you fake coloured pencils).', ru: 'Цвет грифеля (можно имитировать цветные карандаши).' },
  hBrushSize: { en: 'Width of the brush stroke.', ru: 'Ширина мазка кисти.' },
  hBrushPressure: { en: 'How much paint is laid down per pass overall.', ru: 'Сколько краски кладётся за проход в целом.' },
  hBrushLoad: { en: 'How much paint the brush is carrying — more load means it takes longer to run dry along a stroke.', ru: 'Сколько краски набрано на кисть — больше загрузка, дольше кисть не пересыхает вдоль мазка.' },
  hBrushWet: { en: 'How wet the stroke is — wetter shows more sheen, soaks the paper more, and keeps blending after the stroke.', ru: 'Насколько мокрый мазок — выше блеск, сильнее впитывание в бумагу, дольше смешивание после мазка.' },
  hBrushBlend: { en: 'How much a new stroke mixes with wet paint already on the sheet beneath it.', ru: 'Насколько новый мазок смешивается с уже лежащей мокрой краской под ним.' },
  hBrushRandom: { en: 'Bristle-to-bristle variation — higher shows more streaks, gaps and stray flecks near the edge.', ru: 'Разброс между отдельными ворсинками — выше заметнее полосы, пропуски и случайные брызги у края.' },
  hBrushColor: { en: 'Paint colour.', ru: 'Цвет краски.' },
  hTapeSize: { en: 'Width and length of the tape strip.', ru: 'Ширина и длина полоски скотча.' },
  hTapeAngle: { en: 'Strip angle for a single tap. While dragging, the tape follows the direction of your stroke instead.', ru: 'Угол полоски для одиночного касания. При протягивании лента сама следует за направлением движения.' },
  hTapeGloss: { en: 'Overall glossiness of the film, including highlights along folds and creases.', ru: 'Общая глянцевость плёнки, включая блики вдоль сгибов и заломов.' },
  hTapeBubbles: { en: 'How likely and visible trapped air bubbles are under the tape.', ru: 'Насколько вероятны и заметны пузырьки воздуха под лентой.' },
  hTapeWrinkle: { en: 'How likely and visible creases are where the tape didn\u2019t lay flat.', ru: 'Насколько вероятны и заметны заломы там, где лента легла неровно.' },
  hTapeColor: { en: 'Tint of the tape film.', ru: 'Оттенок плёнки скотча.' },
  hGlueSize: { en: 'Reach of the glue pass and how far apart its two strands fall.', ru: 'Охват мазка клея и то, насколько раздельно ложатся его две нити.' },
  hGluePressure: { en: 'How much adhesive soaks into the paper and how visible the dried bead is afterwards.', ru: 'Сколько клея впитывается в бумагу и насколько заметен застывший след после высыхания.' },
  hPatchSize: { en: 'Size of the paper patch. Drag to stretch it along the gesture, or tap once for a square patch of this size.', ru: 'Размер бумажной заплатки. При протяжке растягивается по жесту, при одиночном тапе — квадратный кусочек этого размера.' },
  hBurnSize: { en: 'Radius of the scorch mark, including the faint warm halo around the charred part.', ru: 'Радиус подпалины, включая тёплый ореол вокруг обугленной части.' },
  hBurnPressure: { en: 'How much heat is transferred per pass — higher chars faster and can burn a hole through.', ru: 'Сколько тепла передаётся за проход — выше быстрее обугливание, может прогореть дыра.' },
  hPinsSize: { en: 'Size of the puncture and the torn rim around it.', ru: 'Размер прокола и рваной каймы вокруг него.' },
  hDirtSize: { en: 'Spread of the scattered grime dabs in one pass.', ru: 'Разброс частиц грязи за один мазок.' },
  hDirtPressure: { en: 'How much dust and grease is deposited per pass.', ru: 'Сколько пыли и жирного налёта откладывается за проход.' },
  hDirtGrit: { en: 'How scattered and uneven the grime pattern looks, plus the chance of stray bright dust flecks.', ru: 'Насколько рваным и неровным выглядит узор грязи, плюс вероятность случайных ярких пылинок.' },
  ...
  downloadProject: { en: 'Download project', ru: 'Скачать проект' },
  downloadProjectHint: {
    en: 'Download the project file — open it with "Open project" for an editable copy laid out exactly like the original',
    ru: 'Скачать файл проекта — откройте его через «Открыть проект», чтобы получить редактируемую копию точно как у автора',
  },
  downloadingProject: { en: 'Downloading…', ru: 'Скачивание…' },
  downloadProjectFailed: { en: "Couldn't download this project.", ru: 'Не удалось скачать проект.' },
